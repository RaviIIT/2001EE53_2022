...
def octant_longest_subsequence_count_with_range():
    ...
    try:
          ...
          inp.to_excel('output_octant_longest_subsequence.xlsx', index_col = 0)
          ...
          outp = pd.read_excel('/content/output_octant_longest_subsequence.xlsx')
          ...
          for i in range(1,5):
            ...
            for w in range(cnt - dictn_len[i] + 1):
              ...
              try:
                if flag == True:
                  long_len.append(inp['Time'][0][w])
              except:
                print('errorrrrrrssss')
          ...
          outp['Longest Subsequence Length  '] = long_len

          
          try:
                # writing to output excel file
                outp.to_excel('output_octant_longest_subsequence.xlsx', index_col = 0)
          except:
