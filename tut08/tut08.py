...
def scorecard():
    ...
    try:
       team_file = open('teams.txt')
        ...
        print('Error while reading teams file.')
    count = 0
    while True:
    ...
    # end India innings file
    try:
        file1 = open('india_inns2.txt', 'r')
    except:
        print('Error occured while opening India innigs file')
    ...
    # -------------------------------------------------------------------------------------------------------------------------------------
    try:
        file1 = ('pak_inns1.txt', 'r')
    except:
        print('Error occured while opening pakistan files.')
    ...
    # -------------------------------------------------------------------------------------------------------------------------------
    lines_append.append(f"{'Pakistan Innings' : <60}{str(pak_runs) + '-' + str(pak_wick_down) + ' (' + pak_last_ball + ' Ov)' : >60}")
    ...
    # India scorecard
    lines_append.append(f"{'India Innings' : <60}{str(ind_runs) + '-' + str(ind_wick_down) + ' (' + ind_last_ball + ' Ov)' : >60}")
    lines_append.append(f"{'Batter' : <30}{' ' : <40}{'R' : >10}{'B' : >10}{'4s' : >10}{'6s' : >10}{'SR' : >10}")
    ...
    for lines in lines_append:
        try:
            ...
            print('Error occured while writing scorecard file.')
