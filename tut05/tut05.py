...
def octact_identification(mod=5000):
    ...
    # try:
      ...
      dictn_usls[-1] = 'External outward interaction'
      dictn_usls[2] = 'External ejection'
      dictn_usls[-2] = 'Internal ejection'
      dictn_usls[3] = 'External inward interaction'
      dictn_usls[-3] = 'Internal inward interaction'
      dictn_usls[4] = 'Internal sweep'
      dictn_usls[-4] = 'External sweep'

      rank_one_name = []
      rank_one_name.append(dictn_usls[rank_one_octant[0]])
      rank_one_name.append('')

      for i in range(itr):
        rank_one_name.append(dictn_usls[rank_one_octant[2+i]])
      ...
      for i in range(1,5):
        outp[-1][cur_cnt] = dictn_usls[i]
        outp[-1][cur_cnt+1] = dictn_usls[0-i]
        cur_cnt = cur_cnt + 2
